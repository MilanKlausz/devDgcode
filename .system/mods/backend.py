...
def perform_configuration(cmakeargs=[],
    ...
    if envdict:
        ...
        linkdir=dirs.installdir.joinpath('lib','links')
        utils.rm_rf(linkdir)
    ...
    dgtestfile=dirs.blddir.joinpath('dgtests')
    ...
    cfgfile=dirs.blddir.joinpath('cfg.py')

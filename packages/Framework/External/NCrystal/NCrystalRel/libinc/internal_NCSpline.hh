#ifndef NCrystalRel_Spline_hh
#define NCrystalRel_Spline_hh
...
inline NCrystalRel::CubicSpline::CubicSpline() : m_nm2(0) {}
inline NCrystalRel::CubicSpline::CubicSpline( const VectD& y, double ypa, double ypb ) { set(y,ypa,ypb); }
inline NCrystalRel::CubicSpline::~CubicSpline(){}
inline double NCrystalRel::CubicSpline::evalWithAssert(double x) const {
  nc_assert(x>=0.0&&x<=m_nm2+1);
  return evalUnbounded(x);
}
inline double NCrystalRel::CubicSpline::evalUnbounded(double x) const {
...
inline NCrystalRel::SplinedLookupTable::SplinedLookupTable() : m_a(0), m_invdelta(0), m_b(0) {}
inline NCrystalRel::SplinedLookupTable::SplinedLookupTable( const VectD& fvals,
                                                         double a,double b,
                                                         double fprime_a, double fprime_b,
...
inline NCrystalRel::SplinedLookupTable::~SplinedLookupTable(){}
inline NCrystalRel::SplinedLookupTable::SplinedLookupTable( const Fct1D* thefct,
                                                         double a,double b,
                                                         double fprime_a, double fprime_b,
                                                         unsigned npts,
                                                         const std::string& name,
...
inline double NCrystalRel::SplinedLookupTable::eval(double x) const {
  return m_spline.evalUnbounded((x-m_a)*m_invdelta);
}

inline void NCrystalRel::SplinedLookupTable::swap(NCrystalRel::SplinedLookupTable&o) {
  std::swap(m_a,o.m_a);
  std::swap(m_b,o.m_b);
...
inline void NCrystalRel::CubicSpline::swap(NCrystalRel::CubicSpline&o) {

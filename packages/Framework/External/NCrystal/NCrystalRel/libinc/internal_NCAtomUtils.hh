#ifndef NCrystalRel_AtomUtils_hh
#define NCrystalRel_AtomUtils_hh
...
inline NCrystalRel::AtomSymbol::AtomSymbol(const std::string& ss)
...
inline bool NCrystalRel::AtomSymbol::isInvalid() const { return m_z == 0 && m_a ==0; }
inline bool NCrystalRel::AtomSymbol::isCustomMarker() const { return m_z == 0 && m_a !=0; }
inline bool NCrystalRel::AtomSymbol::isElement() const { return m_z != 0 && m_a ==0; }
inline bool NCrystalRel::AtomSymbol::isIsotope() const { return m_z != 0 && m_a !=0; }
inline unsigned NCrystalRel::AtomSymbol::Z() const { nc_assert(m_z != 0); return m_z; }
inline unsigned NCrystalRel::AtomSymbol::A() const { nc_assert(m_z != 0); return m_a; }

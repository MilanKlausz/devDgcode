...
#define NCrystalRel_SmallVector_hh
...
namespace std {
  ...
  template<class TValue, std::size_t NSMALL, NCrystalRel::SVMode MODE>
  inline void swap(NCrystalRel::SmallVector<TValue,NSMALL,MODE>& a, NCrystalRel::SmallVector<TValue,NSMALL,MODE>& b)
  {
    a.swap(b);
  }
}

#ifndef NCrystalRel_Vector_hh
#define NCrystalRel_Vector_hh
...
inline double NCrystalRel::Vector::mag() const
{
  return std::sqrt( mag2() );
}

inline constexpr double NCrystalRel::Vector::mag2() const
{
  return m_data[0]*m_data[0]+m_data[1]*m_data[1]+m_data[2]*m_data[2];
}

inline constexpr double NCrystalRel::Vector::dot(const NCrystalRel::Vector& o) const
{
  return m_data[0]*o.m_data[0]+m_data[1]*o.m_data[1]+m_data[2]*o.m_data[2];
}

inline ncconstexpr17 NCrystalRel::Vector& NCrystalRel::Vector::operator+=( const NCrystalRel::Vector& o)
{
  m_data[0] += o.m_data[0];
  m_data[1] += o.m_data[1];
  m_data[2] += o.m_data[2];
...
inline ncconstexpr17 NCrystalRel::Vector& NCrystalRel::Vector::operator*= (double f)
{
  m_data[0] *= f;
  m_data[1] *= f;
  m_data[2] *= f;
...
inline ncconstexpr17 NCrystalRel::Vector NCrystalRel::Vector::operator/ (double f) const
{
  const double ff(1.0/f);
...
inline ncconstexpr17 NCrystalRel::Vector NCrystalRel::Vector::operator*(const NCrystalRel::Vector& o) const
{
...
inline ncconstexpr17 void NCrystalRel::Vector::cross_inplace(const Vector&o)
{
...
inline ncconstexpr17 NCrystalRel::Vector NCrystalRel::Vector::operator-() const
{
...
inline NCrystalRel::Vector NCrystalRel::Vector::unit() const
{
  double themag2 = mag2();
  if (themag2==1.0)
    return *this;
...
inline void NCrystalRel::Vector::normalise()
{
  double themag2 = mag2();
  if (themag2==1.0)
    return;
...
inline ncconstexpr17 NCrystalRel::Vector NCrystalRel::Vector::cross(const NCrystalRel::Vector& o) const
{
  return *this * o;
}

inline ncconstexpr17 bool NCrystalRel::Vector::isParallel(const NCrystalRel::Vector& vec2, double epsilon) const
{
...
inline ncconstexpr17 bool NCrystalRel::Vector::isOrthogonal(const Vector& vec2, double epsilon) const
{
...
inline double NCrystalRel::Vector::angle(const NCrystalRel::Vector& vec2) const
{
...
inline double NCrystalRel::Vector::angle_highres(const NCrystalRel::Vector& vec2) const
{
  ...
  //(Jan 11, 2006):
  NCrystalRel::Vector a(*this);
  NCrystalRel::Vector b(vec2);
...
inline constexpr bool NCrystalRel::Vector::isStrictNullVector() const noexcept
{
  return m_data[0]==0.0 && m_data[1]==0.0 && m_data[2]==0.0;
}

inline bool NCrystalRel::Vector::isUnitVector(double tolerance) const
{

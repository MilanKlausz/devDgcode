#ifndef NCrystalRel_SABUtils_hh
#define NCrystalRel_SABUtils_hh
...
#include "NCrystalRel/NCSABData.hh"
...
inline NCrystalRel::Span<const double> NCrystalRel::SABUtils::sliceSABAtBetaIdx_const( NCrystalRel::Span<const double> sab, std::size_t nalpha, std::size_t beta_idx)
{
  nc_assert( (beta_idx+1) * nalpha <= static_cast<std::size_t>(sab.size()) );
  return {sab.begin() + beta_idx*nalpha, sab.begin() + (beta_idx+1)*nalpha};
}

inline NCrystalRel::Span<double> NCrystalRel::SABUtils::sliceSABAtBetaIdx( NCrystalRel::Span<double> sab, std::size_t nalpha, std::size_t beta_idx)
{
  nc_assert( (beta_idx+1) * nalpha <= static_cast<std::size_t>(sab.size()) );
  return {sab.begin() + beta_idx*nalpha, sab.begin() + (beta_idx+1)*nalpha};
}

inline double NCrystalRel::SABUtils::interpolate_loglin_fallbacklinlin(double a, double fa, double b, double fb, double x)
{
...
inline double NCrystalRel::SABUtils::interpolate_loglin_fallbacklinlin_fast(double a, double fa, double b, double fb, double x, double logfa, double logfb)
{
  nc_assert ( fa>=0.0 && fb >= 0.0 );
  nc_assert ( x >= a && x <= b );
...
inline double NCrystalRel::SABUtils::integrateAlphaInterval(double a1,double s1, double a2 , double s2 )
{
...
inline double NCrystalRel::SABUtils::integrateAlphaInterval_fast(double a1,double s1, double a2 , double s2 , double logs1, double logs2)
{
...
inline double NCrystalRel::SABUtils::sampleLogLinDist(double a, double fa, double b, double fb, double rand)
{
...
inline double NCrystalRel::SABUtils::sampleLogLinDist_fast(double a, double fa, double b, double fb, double rand, double logfa, double logfb)
{

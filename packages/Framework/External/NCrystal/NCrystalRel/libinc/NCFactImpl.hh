...
#define NCrystalRel_FactImpl_hh
...
namespace NCrystalRel {
  ...
  namespace FactImpl {
    ...
    public:
      using Priority = ::NCrystalRel::Priority;
    ...
    public:
      ...
      //Wraps ::NCrystalRel::FactImpl::createScatter but avoids our own factory for consideration:

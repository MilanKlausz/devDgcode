...
#ifdef ncrystalrel_join
#  undef ncrystalrel_join
#endif
#ifdef ncrystalrel_xjoin
#  undef ncrystalrel_xjoin
#endif
...
#endif
#define ncrystalrel_join( symbol1, symbol2 ) ncrystalrel_xjoin( symbol1, symbol2 )
#define ncrystalrel_xjoin( symbol1, symbol2 ) symbol1##symbol2
#ifdef NCRYSTAL_DEBUG_LOCKS
#  define NCRYSTAL_LOCK_GUARD(MtxVariable) ::NCrystalRel::LockGuard ncrystalrel_join(nc_lock_guard_instance_line,__LINE__)(MtxVariable,__FILE__,__LINE__)
...
#  include <iostream>
#else
#  define NCRYSTAL_LOCK_GUARD(MtxVariable) ::NCrystalRel::LockGuard ncrystalrel_join(nc_lock_guard_instance_line,__LINE__)(MtxVariable)

#ifndef NCrystalRel_CfgVars_hh
#define NCrystalRel_CfgVars_hh
...
namespace NCrystalRel {
  ...
  namespace Cfg {
    ...
    struct vardef_infofactory final : public ValStr<vardef_infofactory> {
      ...
      static constexpr auto group = VarGroupId::Info;
#ifdef ncrystalrel_detail_xxxfact_descr_helper
#  undef ncrystalrel_detail_xxxfact_descr_helper
#endif
#define ncrystalrel_detail_xxxfact_descr_helper(x)                         \
      ...
      static constexpr auto description = ncrystalrel_detail_xxxfact_descr_helper("material Info");
    ...
    struct vardef_scatfactory final : public ValStr<vardef_scatfactory> {
      ...
      static constexpr auto group = VarGroupId::ScatterBase;
      static constexpr auto description = ncrystalrel_detail_xxxfact_descr_helper("Scatter");
      static constexpr value_type default_value() { return StrView::make(""); }
      static Variant<StrView,std::string> str2val( StrView sv ) {
        try {
          return FactNameRequest::Parser::doParse(sv).to_string();
    ...
    struct vardef_absnfactory final : public ValStr<vardef_absnfactory> {
      ...
      static constexpr auto description = ncrystalrel_detail_xxxfact_descr_helper("Absorption");
      static constexpr value_type default_value() { return StrView::make(""); }
      static Variant<StrView,std::string> str2val( StrView sv ) {
        try {
          return FactNameRequest::Parser::doParse(sv).to_string();

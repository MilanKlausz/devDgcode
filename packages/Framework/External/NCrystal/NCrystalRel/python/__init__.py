...
def _load(nclib_filename):
    ...
    def iter_hkllist(nfo,all_indices=False):
        ...
        for idx in range(nhkl):
            _rawfct['ncrystalrel_info_gethkl'](nfo,idx,h,k,l,mult,dsp,fsq)
            if not all_indices:
...
class Info(RCBase):
    ...
    def __init__(self, cfgstr):
        ...
        self.__comp=None
        self._som=None
        self._nphases = int(_rawfct['ncrystalrel_info_nphases'](rawobj))
    ...
    def __initPhases(self):
        ...
        for i in range(self._nphases):
            ...
            ph_info_raw = _rawfct['ncrystalrel_info_getphase'](self._rawobj,i,fraction)
    ...
    def dump(self,verbose=0):
        ...
        sys.stdout.flush()
        sys.stderr.flush()
        _rawfct['ncrystalrel_dump_verbose'](self._rawobj,min(999,max(0,int(verbose))))
    ...
    def getSLD(self):
        ...
        return _rawfct['ncrystalrel_info_getsld'](self._rawobj)
    sld = property(getSLD)
    ...
    def getBraggThreshold(self):
        ...
        """
        bt = float(_rawfct['ncrystalrel_info_braggthreshold'](self._rawobj))
    ...
    def hklInfoType(self):
        ...
        return HKLInfoType(int(_rawfct['ncrystalrel_info_hklinfotype'](self._rawobj)))

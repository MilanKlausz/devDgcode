...
NCrystalRel::EqRefl::EqRefl(int sg)
{
  if (sg<1||sg>230)
...
NCrystalRel::EqRefl::~EqRefl()
{
}

const std::set<NCrystalRel::EqRefl::HKL>& NCrystalRel::EqRefl::getEquivalentReflections(int h, int k, int l)
{
  m_planes.clear();
...
void NCrystalRel::EqRefl::calc_Triclinic_1_2(int, int, int)
{
}

void NCrystalRel::EqRefl::calc_Monoclinic_3_15(int h, int k, int l)
{
  add(h,-k,l);
}

void NCrystalRel::EqRefl::calc_Orthorhombic_16_74(int h, int k, int l)
{
  add(h,-k,-l); add(h,-k,l); add(h,k,-l);
}

void NCrystalRel::EqRefl::calc_Tetragonal_75_88(int h, int k, int l)
{
  add(k,-h,-l); add(h,k,-l); add(k,-h,l);
}

void NCrystalRel::EqRefl::calc_Tetragonal_89_142(int h, int k, int l)
{
  add(k,h,l); add(k,-h,-l); add(h,k,-l);
  add(k,-h,l); add(h,-k,-l); add(k,h,-l); add(h,-k,l);
}

void NCrystalRel::EqRefl::calc_Trigonal_143_148(int h, int k, int l)
{
  add(h+k,-h,-l); add(k,-h-k,l);
}

void NCrystalRel::EqRefl::calc_Trigonal_149_167(int h, int k, int l)
{
  add(h+k,-h,-l); add(k,-h-k,l); add(k,h,-l); add(h+k,-k,l); add(h,-h-k,-l);
}

void NCrystalRel::EqRefl::calc_Hexagonal_168_176(int h, int k, int l)
{
  add(h,k,-l); add(k,-h-k,-l); add(k,-h-k,l); add(h+k,-h,l); add(h+k,-h,-l);
}

void NCrystalRel::EqRefl::calc_Hexagonal_177_194(int h, int k, int l)
{
...
void NCrystalRel::EqRefl::calc_Cubic_195_206(int h, int k, int l)
{
  add(h,-k,-l); add(h,-k,l); add(h,k,-l);
...
void NCrystalRel::EqRefl::calc_Cubic_207_230(int h, int k, int l)
{
  add(h,-k,-l); add(h,-k,l); add(h,k,-l);
  add(k,l,h); add(k,-l,-h); add(k,-l,h); add(k,l,-h);
  add(l,h,k); add(l,-h,-k); add(l,-h,k); add(l,h,-k);

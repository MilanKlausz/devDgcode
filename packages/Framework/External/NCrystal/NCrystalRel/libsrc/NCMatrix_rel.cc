...
#include "NCrystalRel/internal_NCMatrix.hh"
#include <iostream>

NCrystalRel::Matrix::~Matrix()
{
}

NCrystalRel::Matrix NCrystalRel::operator*(const NCrystalRel::Matrix& m1, const NCrystalRel::Matrix& m2)
{
...
void NCrystalRel::Matrix::rref(double epsilon)
{
  unsigned r = 0;
...
void NCrystalRel::Matrix::inv(double epsilon  )
{
...
NCrystalRel::Matrix NCrystalRel::Matrix::getInv(double epsilon) const
{
...
std::ostream& NCrystalRel::operator << (std::ostream & o, const NCrystalRel::Matrix& matrix)
{
  o << " {\n";
...
void NCrystalRel::Matrix::print() const
{

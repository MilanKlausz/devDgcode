...
NCrystalRel::RotMatrix::RotMatrix(const NCrystalRel::Vector v, const NCrystalRel::Vector& v_trf,
                               const NCrystalRel::Vector u, const NCrystalRel::Vector& u_trf,
                               double tolerance )
  : Matrix()
{
...
double NCrystalRel::RotMatrix::determinant() const
{
...
void NCrystalRel::rotateToFrame( double sinab, double cosab, const Vector& a, const Vector& b, Vector&v, RNG * rng )
{
